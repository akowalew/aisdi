...
//   BOOST_CHECK_THROW(collection.end() + 1, std::out_of_range);
//   BOOST_CHECK_THROW((collection.end() + 1), std::out_of_range);
//   BOOST_CHECK_THROW(collection.cend() + 1, std::out_of_range);
//   BOOST_CHECK_THROW((collection.cend() + 1), std::out_of_range);
// }
                              ...
                              TestedTypes)
{
  ...
  BOOST_CHECK(it - 2 == begin(collection) + 1);
}
                              ...
                              TestedTypes)
{
  ...
  collection.insert(begin(collection) + 1, 42);
                              ...
                              TestedTypes)
{
  ...
  BOOST_CHECK_EQUAL(collection.popFront(), 101);
}
                              ...
                              TestedTypes)
{
  ...
  collection.erase(end(collection) - 1);
                              ...
                              TestedTypes)
{
  ...
  collection.erase(begin(collection) + 1);
